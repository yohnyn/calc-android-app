...
个人使用的 Android 仓位助手项目，用于本地模拟 U 本位和币本位合约仓位的收益、亏损、ROI、保证金、估算强平价、目标价格、补仓助手、方案库和开仓方案对比。
...
- 首页一级模块固定为：仓位参数、结果缩略、开仓方案对比、补仓助手、目标价格轻入口、历史 / 方案库 / 设置等低权重入口。
